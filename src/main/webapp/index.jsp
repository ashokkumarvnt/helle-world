...
<head>
  ...
  <!-- site metas -->
  <title>Cutee computers - IT solution Responsive Html Theme</title>
  <link rel="shortcut icon" href="images/fevicon/fav.png" type="image/png" />
            ...
            <div class="menu_side">
              <div id="navbar_menu">
                <ul class="first-ul">
                  ...
                  <li> <a href="it_contact.html">Contact us</a
                </ul>
              </div>
            <!-- menu end -->
          </div>
            ...
            <ul>
              ...
              <li data-index="rs-18" data-transition="zoomin" data-slotamount="7" data-easein="Power4.easeInOut"
                ...
                <div class="tp-caption NotGeneric-Title   tp-resizeme rs-parallaxlevel-0" id="slide-18-layer-1"
                  ...
                  data-mask_out="x:inherit;y:inherit;s:inherit;e:inherit;" data-start="1000" data-splitin="chars"
                  data-splitout="none" data-responsive_offset="on" data-elementdelay="0.05"
                  style="z-index: 6; white-space: nowrap;">AWS solution </div>
                <!-- LAYER NR. 3 -->
      ...
      <div class="row">
        ...
        <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
          <div class="full text_align_center margin_bottom_30">
            ...
            <h4 class="theme_color">AWS solution</h4>
      ...
      <div class="row" style="margin-top: 35px">
                ...
                <div class="panel-group" id="accordion">
                  <div class="panel panel-default">
                    ...
                    <div id="collapseOne" class="panel-collapse collapse in">
                      <div class="panel-body">
                        <p>Cutee solution ensures all OEM products front-lined by it comply with stringent SLA requirements
                           and match the end user's requirements.From installation to warranty services, operating manpower and management,
                  ...
                  <div class="panel panel-default">
                    ...
                    <div id="collapseThree" class="panel-collapse collapse">
                      <div class="panel-body">
                        <p>Multi-Cloud Management Services that includes AWS, Azure and GCP. CMS IT has partnerships with all the top cloud service providers and has an array of certified cloud engineers who help the customers manage the cloud environment of their customers.
                          Governance between cloud service providers and the clients to ensure the smooth running of the IT Operations.
                          Workload Migration between the private cloud and public cloud – between public cloud providers and so on.
                          ...
                          Continuously monitor the usage of instances and plan the commercials of the instances in the best possible manner.
                          Use the DevOps methodology to ensure the agility of changes for the client business.
                          cutee IT understands that no two offerings from Cloud Service Providers are the same and therefore provide the best-in-class solutions that are available across the set ups.
                          Cutee IT is well-versed in cloud-native tools and provides a seamless experience of usage across the different cloud service providers.
                  ...
                  <div class="panel panel-default">
                    ...
                    <div id="collapseFour" class="panel-collapse collapse in">
                      <div class="panel-body">
                        <p>Today IT automation is one of the most important business processes and the most relevant adoption done by enterprises. This automation adoption helps drive resource optimization and improve productivity. With everyday innovations Automation is today capable of delivering the most complex workflows from infrastructure provisioning to real-time monitoring, detecting and removing network security threats.
                          ...
                          Cutee  IT with the infusion of Artificial Intelligence for troubleshooting and maintenance of network best practices helps save cost, avoid critical errors, and reduce downtime. </p>
                      </div>
                    </div>
                  </div>
                </div>
        ...
        <div class="col-md-4">
          <div class="full" style="margin-top: 35px;">
            ...
            <p>Organizations are finding advanced ways to power technologies with operations automation, through Artificial intelligence, machine learning, Self-help and predictive analytics, and leverage the fastest growing solutions in the market for deep data insights and analytics.
            ...
            <div class="col-md-4">
              <div class="full">
                <div class="service_blog_inner">
                  ...
                  <p>uses advanced web technologies and new user interfaces, to simplify and speed up the work of the people who manage the service..</p>
                </div>
              </div>
            </div>
            <div class="col-md-4">
              <div class="full">
                <div class="service_blog_inner">
                  ...
                  <p>Secure Payment Services is a safer, faster, more secure way to pay online with, your payments sent directly to the prison.</p>
                </div>
              </div>
            </div>
            <div class="col-md-4">
              <div class="full">
                <div class="service_blog_inner">
                  ...
                  <p>The first and most important reason that our services are competitively priced is because we choose to be affordable.</p>
                </div>
              </div>
            </div>
            <div class="col-md-4">
              <div class="full">
                <div class="service_blog_inner">
                  ...
                  <p>Installation warranted to the original purchaser to be free from defects in material or workmanship for a period of ninety days from the date of the original retail purchase..</p>
                </div>
              </div>
            </div>
            <div class="col-md-4">
              <div class="full">
                <div class="service_blog_inner">
                  ...
                  <p>To be honored by your peers is incredibly gratifying and I am so thankful to my colleagues across the league for this recognition.</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="col-md-8">
          <div class="row">
            ...
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 margin_bottom_50">
              ...
              <div class="text_align_right">
                <p class="counter-heading">AWS solution</p>
              </div>
        ...
        <div class="col-md-4">
          <div class="full blog_colum">
            ...
            <div class="blog_feature_head">
              <h4>The Cloud Operating Model – Optimize Costs, Enhance Availability, Drive Performance</h4>
            </div>
  ...
  <footer class="footer_style_2">
    <div class="container-fuild">
      <div class="row">
        ...
        <div class="footer_blog">
          <div class="row">
            <div class="col-md-6">
              ...
              <p>Cutee IT Services is an industry leader in Managed IT services and system integration. We offer an integrated portfolio of solutions combining the power of cutting-edge technology in  workplace,Automation, Cloud, Network & Digital.</p>
        ...
        <div class="cprt">
          <p>Cutee computers © Copyrights 2022 Design by html.design</p>
        </div>
      </div>
    </div>
  </footer>
